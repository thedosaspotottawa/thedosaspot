...
function Admin() {
        ...
        return (
            <div className="max-w-md mx-auto py-32 px-4">
                <motion.div
                    ...
                    className="bg-white/80 backdrop-blur-xl p-12 rounded-[2.5rem] shadow-2xl border border-primary/10"
                >
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            className="w-full bg-primary text-white font-black py-5 rounded-2xl hover:bg-secondary transition-all shadow-xl active:scale-[0.98]"
                        >
                            Unlock Dashboard
                        </button>
                    </form>
    ...
    return (
        <section className="py-12 min-h-[80vh] relative">
                    ...
                    <div className="bg-white rounded-xl shadow-lg border border-primary/10 overflow-hidden">
                        <div className="overflow-x-auto">
                            <table className="w-full text-left">
                                <thead className="bg-gray-50 border-b border-primary/20 text-xs text-primary uppercase tracking-wider">
                                    <tr>
                    ...
                    <div className="space-y-8">
                        <div className="flex justify-between items-center bg-accent/10 p-4 rounded-xl border border-accent/20">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className="bg-white border border-primary/30 text-primary px-3 py-1.5 rounded-lg font-bold text-xs flex items-center gap-2 hover:bg-gray-50 transition-all"
                                >
                        ...
                        <div className="grid gap-6">
                            {menu.categories.map((category) => (
                                <div key={category.id} className="bg-white rounded-2xl shadow-md border border-primary/10 overflow-hidden">
                        ...
                        <div className="grid gap-4">
                            {banners.map((banner) => (
                                <motion.div
                                    ...
                                    className="bg-white p-4 rounded-xl shadow-sm border border-primary/10 flex justify-between items-center group hover:border-accent/30 transition-all"
                                >
            ...
            {isItemModalOpen && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl overflow-y-auto max-h-[90vh]">
                        <h3 className="text-xl font-bold text-primary mb-6">{editingItem ? 'Edit Item' : 'New Menu Item'}</h3>
